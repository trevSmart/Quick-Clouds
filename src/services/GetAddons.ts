...
function getAddons(env, storageManager, context) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const url = env + '/api/v2/add-on?filter[service_id]=2';
        const options = {
            method: 'GET',
            url,
            headers
        ...
        try {
            ...
            if (axios_1.default.isAxiosError(error)) {
                ...
                if (authType === 'credentials') {
                    ...
                    console.error('Error in getAddons:', (_a = error.response) === null || _a === void 0 ? void 0 : _a.statusText);
                }
            }
            else {
