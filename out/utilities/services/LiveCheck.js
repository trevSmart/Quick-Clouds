    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const doRequest = () => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const isDbg = ((_e = dbg === null || dbg === void 0 ? void 0 : dbg.isDebug) === null || _e === void 0 ? void 0 : _e.call(dbg)) === true;
                if (isDbg) {
        ...
        try {
            ...
            if (axios_1.default.isAxiosError(error)) {
                ...
                if (authType === 'credentials') {
                    ...
                    const errorDetails = {
                        status: ((_l = error.response) === null || _l === void 0 ? void 0 : _l.status) || 'Unknown',
                        statusText: ((_m = error.response) === null || _m === void 0 ? void 0 : _m.statusText) || 'Unknown',
                        data: ((_o = error.response) === null || _o === void 0 ? void 0 : _o.data) ? JSON.stringify(error.response.data).substring(0, 200) + '...' : 'No response data'
                    };
