        ...
        try {
            ...
            if (axios_2.default.isAxiosError(error)) {
                ...
                if (authType === 'credentials') {
                    ...
                    return await ApiService_2.ApiService.handle401AndRetry(error, () => axios_2.default.patch(url, JSON.stringify(data), { headers }), refreshTokenValue, (tokens) => ApiService_2.ApiService.setTokens(storageManager, tokens));
                }
                else {
...
//# sourceMappingURL=BulkWriteOff.js.map
